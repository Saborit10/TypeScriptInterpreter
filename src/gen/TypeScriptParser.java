...
public class TypeScriptParser extends Parser {
	...
	public static class AfterCaseClauseListContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TypeScriptVisitor ) return ((TypeScriptVisitor<? extends T>)visitor).visitAfterCaseClauseList(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprMathFuncContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TypeScriptVisitor ) return ((TypeScriptVisitor<? extends T>)visitor).visitExprMathFunc(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MathFunctionNameContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TypeScriptVisitor ) return ((TypeScriptVisitor<? extends T>)visitor).visitMathFunctionName(this);
			else return visitor.visitChildren(this);
		}
	}
