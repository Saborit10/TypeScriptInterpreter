...
public class TypeScriptParser extends Parser {
	...
	public static class ArithmeticExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TypeScriptListener ) ((TypeScriptListener)listener).enterArithmeticExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TypeScriptListener ) ((TypeScriptListener)listener).exitArithmeticExpr(this);
		}
	}
